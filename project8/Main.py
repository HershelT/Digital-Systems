...
class CodeWriter:
    ...
    def writeCall(self, function_name : str, num_args : int):
        ...
        return_address = f"{self.current_file}.{function_name}$ret.{self.function_count}"
...
def main(path):
    ...
    for vm_file in vm_files:
        just_file = os.path.splitext(os.path.basename(vm_file))[0]
        codeWriter.current_file = just_file
        print("Just File: ", just_file)
